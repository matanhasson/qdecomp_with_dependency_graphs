...
from dependencies_graph.create_dependencies_graphs import get_tokens_dependencies_generator
from dependencies_graph.config.configuration_loader import config

from dependencies_graph.data_types import TokensDependencies, SpansDependencies
from dependencies_graph.examine_predictions import predict_all_set, json_file_to_dependencies_graphs, \
    prediction_to_dependencies_graph
from dependencies_graph.extractors.tokens_dependencies_extractors.collapsers import BaseCollapser
from evaluation.decomposition import Decomposition

import os
from dependencies_graph.evaluation.spans_dependencies_to_logical_form_tokens import SpansDepToQDMRStepTokensConverter
from dependencies_graph.evaluation.qdmr_to_logical_form_tokens import QDMRToQDMRStepTokensConverter
from dependencies_graph.evaluation.logical_form_matcher import LogicalFromStructuralMatcher, QDMRStepTokensDependencies
from scripts.eval.evaluate_predictions import get_predictions_from_allennlp_preds_file, format_qdmr
