...
import utils.data_structures as util

from dependencies_graph.data_types import TokensDependencies, SpansDependencies, SpansData, DependencyType, Span
from dependencies_graph.extractors.tokens_dependencies_to_qdmr_extractors.converters import BaseCollapser, JoinCollapser
from dependencies_graph.extractors.tokens_dependencies_to_qdmr_extractors.converters import _get_refs_if_match
...
import scripts.qdmr_to_logical_form.operator_identifier as op
...
from dependencies_graph.debug_dependencies_creation import to_dependencies_and_back_from_dataset
import os
...
if __name__ == '__main__':
    ...
    from evaluation.normal_form.operations_normalization_rules__new import NewWrapperDecomposeRule
