...
import utils.html as utils_html
from dependencies_graph.config.configuration_loader import config, save
from dependencies_graph.evaluation.evaluate_dep_graph import evaluate_dep_graph
from evaluation.decomposition import Decomposition
from scripts.eval.evaluate_predictions import evaluate, evaluate_predictions, format_qdmr

from dependencies_graph.data_types import StepsSpans, StepsDependencies, TokensDependencies, SpansDependencies
