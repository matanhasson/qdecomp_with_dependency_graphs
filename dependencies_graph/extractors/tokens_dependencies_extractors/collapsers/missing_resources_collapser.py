...
from dependencies_graph.data_types import SpansDependencies, SpansData, Span
from dependencies_graph.data_types.steps_spans import TokenData
from dependencies_graph.extractors.tokens_dependencies_extractors.collapsers.base_collapser import BaseCollapser
from scripts.data_processing.break_app_store_generation import get_additional_resources
