...
from dependencies_graph.data_types import TokenDependencyType, \
...
from dependencies_graph.extractors.tokens_dependencies_extractors.collapsers.base_collapser import BaseCollapser
