...
from dependencies_graph.extractors.steps_spans_extractors.aligners.base_aligner import BaseAligner
from evaluation.decomposition import Decomposition
from dependencies_graph.data_types import QDMROperation, Span, StepsSpans
from dependencies_graph.extractors.steps_spans_extractors.base_steps_spans_extractor import BaseSpansExtractor

from scripts.data_processing.break_app_store_generation import get_lexicon_tokens
